  ...
  <el-dialog title='详情' :visible.sync="visible" :close-on-click-modal="false" :before-close="close"  width="40%">
    <el-form :model="service">
      ...
      <el-form-item label="clientID" :label-width="formLabelWidth">
        {{service.id}}
        <el-button type="primary" @click="copy(service.id)" size="small">复制</el-button>
      </el-form-item>
      <el-form-item label="clientKey" :label-width="formLabelWidth">
        {{service.clientKey}}
        <el-button type="primary" @click="copy(service.clientKey)" size="small">复制</el-button>
      </el-form-item>
...
<script>
import { getOne } from '@/api/service'
