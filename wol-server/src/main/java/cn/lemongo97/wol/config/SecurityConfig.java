...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers(HttpMethod.GET, "/lo").permitAll()
                ...
                .and()
                .addFilterAt(new AbstractAuthenticationProcessingFilter("/login", authenticationManager()) {
                    @Override
                ...
                .addFilterAt(new GenericFilterBean() {
                    @Override
